...
def generate_4see_magic_excel():
    ...
    df_all_cards = pd.DataFrame([
        {"Card_ID": "CARD-01", "Card_Title": "Total Orders (Active Shopify Orders)", "Primary_Value": total_orders, "Display_Value": "196", "Subtext_Line_1": "Active Shopify Orders", "Subtext_Line_2": "196 total store orders", "Full_Card_Text": f"Total Orders: {total_orders} | Subtext: Active Shopify Orders"},
        {"Card_ID": "CARD-02", "Card_Title": f"Total Revenue (From {total_orders} active orders)", "Primary_Value": total_revenue, "Display_Value": f"₹{total_revenue:,.2f}", "Subtext_Line_1": f"From {total_orders} active orders", "Subtext_Line_2": "Gross total sales", "Full_Card_Text": f"Total Revenue: ₹{total_revenue:,.2f} | Subtext: From {total_orders} active orders"},
        {"Card_ID": "CARD-03", "Card_Title": f"Net Revenue ({net_orders_count} net orders: {successful_count} delivered + {in_progress_count} in progress)", "Primary_Value": net_revenue_val, "Display_Value": f"₹{net_revenue_val:,.2f}", "Subtext_Line_1": f"{net_orders_count} net orders (86.2% of total: {successful_count} delivered + {in_progress_count} in progress)", "Subtext_Line_2": "Excludes RTO & Canceled", "Full_Card_Text": f"Net Revenue: ₹{net_revenue_val:,.2f} | Subtext: {net_orders_count} net orders ({successful_count} delivered + {in_progress_count} in progress)"},
        ...
        {"Card_ID": "CARD-05", "Card_Title": f"COD Net Revenue (From {cod_delivered_count} delivered COD orders)", "Primary_Value": cod_net_revenue, "Display_Value": f"₹{cod_net_revenue:,.2f}", "Subtext_Line_1": f"From {cod_delivered_count} delivered COD orders", "Subtext_Line_2": "Net delivered COD revenue", "Full_Card_Text": f"COD Net Revenue: ₹{cod_net_revenue:,.2f} | Subtext: From {cod_delivered_count} delivered COD orders"},
        {"Card_ID": "CARD-06", "Card_Title": f"Avg COD Order Value (COD net / {cod_delivered_count} successful)", "Primary_Value": cod_aov, "Display_Value": f"~ ₹{cod_aov:,.2f}", "Subtext_Line_1": f"COD net revenue / {cod_delivered_count} successful", "Subtext_Line_2": f"Average value of {cod_delivered_count} delivered COD orders", "Full_Card_Text": f"Avg COD Order Value: ~ ₹{cod_aov:,.2f} | Subtext: COD net revenue / {cod_delivered_count} successful"},
        {"Card_ID": "CARD-07", "Card_Title": f"Prepaid Net Revenue (From {prepaid_delivered_count} delivered Prepaid orders)", "Primary_Value": prepaid_net_revenue, "Display_Value": f"₹{prepaid_net_revenue:,.2f}", "Subtext_Line_1": f"From {prepaid_delivered_count} delivered Prepaid orders", "Subtext_Line_2": "Net delivered prepaid revenue", "Full_Card_Text": f"Prepaid Net Revenue: ₹{prepaid_net_revenue:,.2f} | Subtext: From {prepaid_delivered_count} delivered Prepaid orders"},
        {"Card_ID": "CARD-08", "Card_Title": f"Avg Prepaid Order Value (Prepaid net / {prepaid_delivered_count} successful)", "Primary_Value": prepaid_aov, "Display_Value": f"~ ₹{prepaid_aov:,.2f}", "Subtext_Line_1": f"Prepaid net revenue / {prepaid_delivered_count} successful", "Subtext_Line_2": f"Average value of {prepaid_delivered_count} delivered Prepaid orders", "Full_Card_Text": f"Avg Prepaid Order Value: ~ ₹{prepaid_aov:,.2f} | Subtext: Prepaid net revenue / {prepaid_delivered_count} successful"},
        
        {"Card_ID": "CARD-09", "Card_Title": f"Successful Orders ({successful_count} delivered of {total_orders} total orders)", "Primary_Value": successful_count, "Display_Value": f"{successful_count}", "Subtext_Line_1": f"{successful_count} delivered of {total_orders} total orders", "Subtext_Line_2": f"Count {successful_count} | Successful Revenue ₹{successful_val:,.2f} | Successful Rate {(successful_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Successful Orders: {successful_count} | Revenue: ₹{successful_val:,.2f} | Rate: {(successful_count/total_orders)*100:.1f}% | Subtext: {successful_count} delivered of {total_orders} total orders"},
        {"Card_ID": "CARD-10", "Card_Title": f"Denied Orders (Doorstep RTO) ({denied_count} refused of 76 COD orders)", "Primary_Value": denied_count, "Display_Value": f"{denied_count}", "Subtext_Line_1": f"{denied_count} denied of {total_orders} total orders (19.7% of 76 COD)", "Subtext_Line_2": f"Count {denied_count} | Total Amount ₹{denied_val:,.2f} | Denied Rate {(denied_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Denied Orders: {denied_count} | Amount: ₹{denied_val:,.2f} | Rate: {(denied_count/total_orders)*100:.1f}% | Subtext: {denied_count} doorstep delivery refusals"},
        {"Card_ID": "CARD-11", "Card_Title": f"Returned Orders ({returned_count} customer returns of {successful_count} delivered)", "Primary_Value": returned_count, "Display_Value": f"{returned_count}", "Subtext_Line_1": f"{returned_count} customer post-delivery returns of {successful_count} delivered", "Subtext_Line_2": f"Count {returned_count} | Total Refunded ₹{returned_val:,.2f} | Return Rate {(returned_count/successful_count)*100:.1f}%", "Full_Card_Text": f"Returned Orders: {returned_count} | Refunded: ₹{returned_val:,.2f} | Rate: {(returned_count/successful_count)*100:.1f}% | Subtext: {returned_count} customer post-delivery returns"},
        {"Card_ID": "CARD-12", "Card_Title": f"Canceled Orders ({canceled_count} canceled of {total_orders} total orders)", "Primary_Value": canceled_count, "Display_Value": f"{canceled_count}", "Subtext_Line_1": f"{canceled_count} canceled of {total_orders} total orders", "Subtext_Line_2": f"Count {canceled_count} | Total Amount ₹{canceled_val:,.2f} | Canceled Rate {(canceled_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Canceled Orders: {canceled_count} | Amount: ₹{canceled_val:,.2f} | Rate: {(canceled_count/total_orders)*100:.1f}% | Subtext: {canceled_count} canceled of {total_orders} total orders"},
        
        {"Card_ID": "CARD-13", "Card_Title": f"Total In-Progress Pipeline ({in_progress_count} orders awaiting delivery)", "Primary_Value": in_progress_count, "Display_Value": f"{in_progress_count}", "Subtext_Line_1": f"{in_progress_count} orders awaiting delivery of {total_orders}", "Subtext_Line_2": f"Count {in_progress_count} | Total Amount ₹{in_progress_val:,.2f} | Active Rate {(in_progress_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Total In-Progress: {in_progress_count} | Amount: ₹{in_progress_val:,.2f} | Rate: {(in_progress_count/total_orders)*100:.1f}% | Subtext: {in_progress_count} orders awaiting delivery"},
        {"Card_ID": "CARD-14", "Card_Title": f"In Transit ({len(in_transit_df)} orders on the way of {total_orders})", "Primary_Value": len(in_transit_df), "Display_Value": f"{len(in_transit_df)}", "Subtext_Line_1": f"{len(in_transit_df)} orders on the way of {total_orders}", "Subtext_Line_2": f"Count {len(in_transit_df)} | Total Amount ₹{float(in_transit_df['Total Price'].sum()):,.2f} | Transit Rate {(len(in_transit_df)/total_orders)*100:.1f}%", "Full_Card_Text": f"In Transit: {len(in_transit_df)} | Amount: ₹{float(in_transit_df['Total Price'].sum()):,.2f} | Subtext: {len(in_transit_df)} orders on the way"},
        {"Card_ID": "CARD-15", "Card_Title": f"Pickup Scheduled ({len(pickup_df)} orders ready for pickup of {total_orders})", "Primary_Value": len(pickup_df), "Display_Value": f"{len(pickup_df)}", "Subtext_Line_1": f"{len(pickup_df)} orders ready for pickup of {total_orders}", "Subtext_Line_2": f"Count {len(pickup_df)} | Total Amount ₹{float(pickup_df['Total Price'].sum()):,.2f} | Pickup Rate {(len(pickup_df)/total_orders)*100:.1f}%", "Full_Card_Text": f"Pickup Scheduled: {len(pickup_df)} | Amount: ₹{float(pickup_df['Total Price'].sum()):,.2f} | Subtext: {len(pickup_df)} orders ready for pickup"},
        {"Card_ID": "CARD-16", "Card_Title": f"Unfulfilled ({len(unfulfilled_df)} orders pending shipment of {total_orders})", "Primary_Value": len(unfulfilled_df), "Display_Value": f"{len(unfulfilled_df)}", "Subtext_Line_1": f"{len(unfulfilled_df)} orders pending shipment of {total_orders}", "Subtext_Line_2": f"Count {len(unfulfilled_df)} | Total Amount ₹{float(unfulfilled_df['Total Price'].sum()):,.2f} | Unfulfilled Rate {(len(unfulfilled_df)/total_orders)*100:.1f}%", "Full_Card_Text": f"Unfulfilled: {len(unfulfilled_df)} | Amount: ₹{float(unfulfilled_df['Total Price'].sum()):,.2f} | Subtext: {len(unfulfilled_df)} orders pending shipment"},
        
        {"Card_ID": "CARD-17", "Card_Title": "Total Meta Ad Spend (Apr 01 - Aug 04)", "Primary_Value": 226394.41, "Display_Value": "₹2,26,394.41", "Subtext_Line_1": "Total Meta Ads spend (Apr 01 - Aug 04)", "Subtext_Line_2": "Includes Advantage+, Reels, Insta & WA Ads", "Full_Card_Text": "Total Meta Ad Spend: ₹2,26,394.41 | Subtext: Total Meta Ads spend (Apr 01 - Aug 04)"},
        {"Card_ID": "CARD-18", "Card_Title": "Total Meta Impressions (13.86M ad impressions)", "Primary_Value": 13862586, "Display_Value": "13.86M", "Subtext_Line_1": "13.86M ad impressions served across Meta", "Subtext_Line_2": "13,862,586 total impressions", "Full_Card_Text": "Total Meta Impressions: 13.86M | Subtext: 13.86M ad impressions served"},
        {"Card_ID": "CARD-19", "Card_Title": "Total Meta Reach (13.15M unique users reached)", "Primary_Value": 13156590, "Display_Value": "13.15M", "Subtext_Line_1": "13.15M unique users reached across Meta", "Subtext_Line_2": "13,156,590 total unique reach", "Full_Card_Text": "Total Meta Reach: 13.15M | Subtext: 13.15M unique users reached"},
        {"Card_ID": "CARD-20", "Card_Title": "Cost Per Purchase (CPA) (Ad spend / 196 conversions)", "Primary_Value": 1155.07, "Display_Value": "₹1,155.07", "Subtext_Line_1": "Ad spend / 196 pixel purchase conversions", "Subtext_Line_2": "Average cost to acquire 1 purchase", "Full_Card_Text": "Cost Per Purchase (CPA): ₹1,155.07 | Subtext: Ad spend / 196 pixel purchase conversions"},
        {"Card_ID": "CARD-21", "Card_Title": "Gross ROAS (Gross Sales ₹3,89,789 / Spend ₹2,26,394)", "Primary_Value": 1.72, "Display_Value": "1.72x", "Subtext_Line_1": "Gross Sales (₹3,89,789) / Ad Spend (₹2,26,394)", "Subtext_Line_2": "1.72x Gross Return on Ad Spend", "Full_Card_Text": "Gross ROAS: 1.72x | Subtext: Gross Sales (₹3,89,789) / Ad Spend (₹2,26,394)"},
        {"Card_ID": "CARD-22", "Card_Title": "Net ROAS (Net Sales ₹3,34,273 / Spend ₹2,26,394)", "Primary_Value": 1.48, "Display_Value": "1.48x", "Subtext_Line_1": "Net Sales (₹3,34,273) / Ad Spend (₹2,26,394)", "Subtext_Line_2": "1.48x Net Return on Ad Spend", "Full_Card_Text": "Net ROAS: 1.48x | Subtext: Net Sales (₹3,34,273) / Ad Spend (₹2,26,394)"}
    ])
    ...
    df_exec = pd.DataFrame([
        {"KPI_ID": "KPI-01", "Metric_Title": f"Total Orders (Active Shopify Orders)", "Primary_Value": total_orders, "Unit": "Orders", "Subtext": "Active Shopify Orders", "Full_Card_Display": f"Total Orders: {total_orders} (Active Shopify Orders)", "Progress_Pct": 1.0, "Theme_Color": "Blue"},
        {"KPI_ID": "KPI-02", "Metric_Title": f"Total Revenue (From {total_orders} active orders)", "Primary_Value": total_revenue, "Unit": "INR ₹", "Subtext": f"From {total_orders} active orders", "Full_Card_Display": f"Total Revenue: ₹{total_revenue:,.2f} (From {total_orders} active orders)", "Progress_Pct": 1.0, "Theme_Color": "Green"},
        {"KPI_ID": "KPI-03", "Metric_Title": f"Net Revenue ({net_orders_count} net orders: {successful_count} delivered + {in_progress_count} in progress)", "Primary_Value": net_revenue_val, "Unit": "INR ₹", "Subtext": f"{net_orders_count} net orders ({successful_count} delivered + {in_progress_count} in progress)", "Full_Card_Display": f"Net Revenue: ₹{net_revenue_val:,.2f} ({net_orders_count} net orders)", "Progress_Pct": 1.0, "Theme_Color": "Green"},
        {"KPI_ID": "KPI-04", "Metric_Title": f"Average Order Value (AOV) (Net revenue / {successful_count} successful)", "Primary_Value": aov_val, "Unit": "INR ₹", "Subtext": f"Net revenue / {successful_count} successful", "Full_Card_Display": f"AOV: ₹{aov_val:,.2f} (Net revenue / {successful_count} successful)", "Progress_Pct": 1.0, "Theme_Color": "Blue"}
    ])
    ...
    df_pay_kpi = pd.DataFrame([
        {"KPI_ID": "PAY-01", "Metric_Title": f"Full COD Orders (Pre-July 24 100% Cash on Delivery)", "Primary_Value": len(full_cod_total), "Payment_Type": "Full COD", "Subtext": f"52 full COD orders (₹{full_cod_total['Total Price'].sum():,.2f})", "Theme_Color": "Orange"},
        {"KPI_ID": "PAY-02", "Metric_Title": f"Partial COD Orders (July 24+ Razorpay Advance Paid)", "Primary_Value": len(partial_cod_total), "Payment_Type": "Partial COD", "Subtext": f"23 Razorpay Partial COD orders (₹{partial_cod_total['Total Price'].sum():,.2f})", "Theme_Color": "Orange"},
        {"KPI_ID": "PAY-03", "Metric_Title": f"COD Net Revenue (From {cod_delivered_count} delivered COD orders)", "Primary_Value": cod_net_revenue, "Payment_Type": "COD", "Subtext": f"From {cod_delivered_count} delivered COD orders", "Theme_Color": "Orange"},
        {"KPI_ID": "PAY-04", "Metric_Title": f"Prepaid Net Revenue (From {prepaid_delivered_count} delivered Prepaid orders)", "Primary_Value": prepaid_net_revenue, "Payment_Type": "Prepaid", "Subtext": f"From {prepaid_delivered_count} delivered Prepaid orders", "Theme_Color": "Green"},
        {"KPI_ID": "PAY-05", "Metric_Title": f"Avg Prepaid Order Value (Prepaid net / {prepaid_delivered_count} successful)", "Primary_Value": prepaid_aov, "Payment_Type": "Prepaid", "Subtext": f"Prepaid net revenue / {prepaid_delivered_count} successful", "Theme_Color": "Green"}
    ])
    ...
    df_lifecycle = pd.DataFrame([
        {"Lifecycle_Stage": f"Successful Orders ({successful_count} delivered of {total_orders} total orders)", "Order_Count": successful_count, "Total_Amount_INR": successful_val, "Stage_Rate_Pct": successful_count/total_orders if total_orders > 0 else 0.0, "Subtext": f"{successful_count} delivered of {total_orders} total orders", "Description": "Delivered & self fulfilled", "Status_Color": "Green"},
        {"Lifecycle_Stage": f"Doorstep RTO Denied ({denied_count} refused of 76 COD orders)", "Order_Count": denied_count, "Total_Amount_INR": denied_val, "Stage_Rate_Pct": denied_count/total_orders if total_orders > 0 else 0.0, "Subtext": f"{denied_count} doorstep delivery refusals (out of 76 COD orders)", "Description": "Doorstep delivery denials", "Status_Color": "Red"},
        {"Lifecycle_Stage": f"Post-Delivery Customer Returns ({returned_count} customer returns of {successful_count} delivered)", "Order_Count": returned_count, "Total_Amount_INR": returned_val, "Stage_Rate_Pct": returned_count/successful_count if successful_count > 0 else 0.0, "Subtext": f"{returned_count} customer post-delivery returns (out of {successful_count} delivered)", "Description": "Delivered then sent back", "Status_Color": "Orange"},
        {"Lifecycle_Stage": f"Canceled Orders ({canceled_count} canceled of {total_orders} total orders)", "Order_Count": canceled_count, "Total_Amount_INR": canceled_val, "Stage_Rate_Pct": canceled_count/total_orders if total_orders > 0 else 0.0, "Subtext": f"{canceled_count} canceled of {total_orders} total orders", "Description": "Order not accepted", "Status_Color": "Orange"}
    ])
    ...
    df_pipeline = pd.DataFrame([
        {"Pipeline_Stage": f"Total In-Progress ({in_progress_count} orders awaiting delivery)", "Order_Count": in_progress_count, "Total_Amount_INR": in_progress_val, "Active_Rate_Pct": in_progress_count/total_orders if total_orders > 0 else 0.0, "Subtext": f"{in_progress_count} orders awaiting delivery of {total_orders}", "Theme_Color": "Blue"},
        {"Pipeline_Stage": f"In Transit ({len(in_transit_df)} orders on the way of {total_orders})", "Order_Count": len(in_transit_df), "Total_Amount_INR": float(in_transit_df['Total Price'].sum()), "Active_Rate_Pct": len(in_transit_df)/total_orders if total_orders > 0 else 0.0, "Subtext": f"{len(in_transit_df)} orders on the way of {total_orders}", "Theme_Color": "Blue"},
        {"Pipeline_Stage": f"Pickup Scheduled ({len(pickup_df)} orders ready for pickup of {total_orders})", "Order_Count": len(pickup_df), "Total_Amount_INR": float(pickup_df['Total Price'].sum()), "Active_Rate_Pct": len(pickup_df)/total_orders if total_orders > 0 else 0.0, "Subtext": f"{len(pickup_df)} orders ready for pickup of {total_orders}", "Theme_Color": "Purple"},
        {"Pipeline_Stage": f"Unfulfilled ({len(unfulfilled_df)} orders pending shipment of {total_orders})", "Order_Count": len(unfulfilled_df), "Total_Amount_INR": float(unfulfilled_df['Total Price'].sum()), "Active_Rate_Pct": len(unfulfilled_df)/total_orders if total_orders > 0 else 0.0, "Subtext": f"{len(unfulfilled_df)} orders pending shipment of {total_orders}", "Theme_Color": "Amber"}
    ])
