...
def generate_4see_magic_excel():
    ...
    df_all_cards = pd.DataFrame([
        {"Card_ID": "CARD-01", "Card_Title": "Total Orders", "Primary_Value": f"{total_orders} (Active Shopify Orders)", "Display_Value": f"{total_orders} (Active Shopify Orders)", "Subtext_Line_1": "Active Shopify Orders", "Subtext_Line_2": "196 total store orders", "Full_Card_Text": f"Total Orders: {total_orders} | Subtext: Active Shopify Orders"},
        {"Card_ID": "CARD-02", "Card_Title": "Total Revenue", "Primary_Value": f"₹{total_revenue:,.2f} (From {total_orders} active orders)", "Display_Value": f"₹{total_revenue:,.2f} (From {total_orders} active orders)", "Subtext_Line_1": f"From {total_orders} active orders", "Subtext_Line_2": "Gross total sales", "Full_Card_Text": f"Total Revenue: ₹{total_revenue:,.2f} | Subtext: From {total_orders} active orders"},
        {"Card_ID": "CARD-03", "Card_Title": "Net Revenue", "Primary_Value": f"₹{net_revenue_val:,.2f} ({net_orders_count} net orders: {successful_count} delivered + {in_progress_count} in progress)", "Display_Value": f"₹{net_revenue_val:,.2f} ({net_orders_count} net orders)", "Subtext_Line_1": f"{net_orders_count} net orders (86.2% of total: {successful_count} delivered + {in_progress_count} in progress)", "Subtext_Line_2": "Excludes RTO & Canceled", "Full_Card_Text": f"Net Revenue: ₹{net_revenue_val:,.2f} | Subtext: {net_orders_count} net orders ({successful_count} delivered + {in_progress_count} in progress)"},
        {"Card_ID": "CARD-04", "Card_Title": "Average Order Value (AOV)", "Primary_Value": f"₹{aov_val:,.2f} (Net revenue / {successful_count} successful)", "Display_Value": f"~ ₹{aov_val:,.2f} (Net revenue / {successful_count} successful)", "Subtext_Line_1": f"Net revenue / {successful_count} successful", "Subtext_Line_2": f"Net AOV across {successful_count} delivered", "Full_Card_Text": f"Average Order Value: ~ ₹{aov_val:,.2f} | Subtext: Net revenue / {successful_count} successful"},
        
        {"Card_ID": "CARD-05", "Card_Title": "COD Net Revenue", "Primary_Value": f"₹{cod_net_revenue:,.2f} (From {cod_delivered_count} delivered COD orders)", "Display_Value": f"₹{cod_net_revenue:,.2f} (From {cod_delivered_count} delivered COD orders)", "Subtext_Line_1": f"From {cod_delivered_count} delivered COD orders", "Subtext_Line_2": "Net delivered COD revenue", "Full_Card_Text": f"COD Net Revenue: ₹{cod_net_revenue:,.2f} | Subtext: From {cod_delivered_count} delivered COD orders"},
        {"Card_ID": "CARD-06", "Card_Title": "Avg COD Order Value", "Primary_Value": f"₹{cod_aov:,.2f} (COD net / {cod_delivered_count} successful)", "Display_Value": f"~ ₹{cod_aov:,.2f} (COD net / {cod_delivered_count} successful)", "Subtext_Line_1": f"COD net revenue / {cod_delivered_count} successful", "Subtext_Line_2": f"Average value of {cod_delivered_count} delivered COD orders", "Full_Card_Text": f"Avg COD Order Value: ~ ₹{cod_aov:,.2f} | Subtext: COD net revenue / {cod_delivered_count} successful"},
        {"Card_ID": "CARD-07", "Card_Title": "Prepaid Net Revenue", "Primary_Value": f"₹{prepaid_net_revenue:,.2f} (From {prepaid_delivered_count} delivered Prepaid orders)", "Display_Value": f"₹{prepaid_net_revenue:,.2f} (From {prepaid_delivered_count} delivered Prepaid orders)", "Subtext_Line_1": f"From {prepaid_delivered_count} delivered Prepaid orders", "Subtext_Line_2": "Net delivered prepaid revenue", "Full_Card_Text": f"Prepaid Net Revenue: ₹{prepaid_net_revenue:,.2f} | Subtext: From {prepaid_delivered_count} delivered Prepaid orders"},
        {"Card_ID": "CARD-08", "Card_Title": "Avg Prepaid Order Value", "Primary_Value": f"₹{prepaid_aov:,.2f} (Prepaid net / {prepaid_delivered_count} successful)", "Display_Value": f"~ ₹{prepaid_aov:,.2f} (Prepaid net / {prepaid_delivered_count} successful)", "Subtext_Line_1": f"Prepaid net revenue / {prepaid_delivered_count} successful", "Subtext_Line_2": f"Average value of {prepaid_delivered_count} delivered Prepaid orders", "Full_Card_Text": f"Avg Prepaid Order Value: ~ ₹{prepaid_aov:,.2f} | Subtext: Prepaid net revenue / {prepaid_delivered_count} successful"},
        
        {"Card_ID": "CARD-09", "Card_Title": "Successful Orders", "Primary_Value": f"{successful_count} ({successful_count} delivered of {total_orders} total orders)", "Display_Value": f"{successful_count} ({successful_count} delivered of {total_orders} total orders)", "Subtext_Line_1": f"{successful_count} delivered of {total_orders} total orders", "Subtext_Line_2": f"Count {successful_count} | Successful Revenue ₹{successful_val:,.2f} | Successful Rate {(successful_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Successful Orders: {successful_count} | Revenue: ₹{successful_val:,.2f} | Rate: {(successful_count/total_orders)*100:.1f}% | Subtext: {successful_count} delivered of {total_orders} total orders"},
        {"Card_ID": "CARD-10", "Card_Title": "Denied Orders (Doorstep RTO)", "Primary_Value": f"{denied_count} ({denied_count} refused of 76 COD orders)", "Display_Value": f"{denied_count} ({denied_count} refused of 76 COD orders)", "Subtext_Line_1": f"{denied_count} denied of {total_orders} total orders (19.7% of 76 COD)", "Subtext_Line_2": f"Count {denied_count} | Total Amount ₹{denied_val:,.2f} | Denied Rate {(denied_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Denied Orders: {denied_count} | Amount: ₹{denied_val:,.2f} | Rate: {(denied_count/total_orders)*100:.1f}% | Subtext: {denied_count} doorstep delivery refusals"},
        {"Card_ID": "CARD-11", "Card_Title": "Returned Orders", "Primary_Value": f"{returned_count} ({returned_count} customer returns of {successful_count} delivered)", "Display_Value": f"{returned_count} ({returned_count} customer returns of {successful_count} delivered)", "Subtext_Line_1": f"{returned_count} customer post-delivery returns of {successful_count} delivered", "Subtext_Line_2": f"Count {returned_count} | Total Refunded ₹{returned_val:,.2f} | Return Rate {(returned_count/successful_count)*100:.1f}%", "Full_Card_Text": f"Returned Orders: {returned_count} | Refunded: ₹{returned_val:,.2f} | Rate: {(returned_count/successful_count)*100:.1f}% | Subtext: {returned_count} customer post-delivery returns"},
        {"Card_ID": "CARD-12", "Card_Title": "Canceled Orders", "Primary_Value": f"{canceled_count} ({canceled_count} canceled of {total_orders} total orders)", "Display_Value": f"{canceled_count} ({canceled_count} canceled of {total_orders} total orders)", "Subtext_Line_1": f"{canceled_count} canceled of {total_orders} total orders", "Subtext_Line_2": f"Count {canceled_count} | Total Amount ₹{canceled_val:,.2f} | Canceled Rate {(canceled_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Canceled Orders: {canceled_count} | Amount: ₹{canceled_val:,.2f} | Rate: {(canceled_count/total_orders)*100:.1f}% | Subtext: {canceled_count} canceled of {total_orders} total orders"},
        
        {"Card_ID": "CARD-13", "Card_Title": "Total In-Progress Pipeline", "Primary_Value": f"{in_progress_count} ({in_progress_count} orders awaiting delivery)", "Display_Value": f"{in_progress_count} ({in_progress_count} orders awaiting delivery)", "Subtext_Line_1": f"{in_progress_count} orders awaiting delivery of {total_orders}", "Subtext_Line_2": f"Count {in_progress_count} | Total Amount ₹{in_progress_val:,.2f} | Active Rate {(in_progress_count/total_orders)*100:.1f}%", "Full_Card_Text": f"Total In-Progress: {in_progress_count} | Amount: ₹{in_progress_val:,.2f} | Rate: {(in_progress_count/total_orders)*100:.1f}% | Subtext: {in_progress_count} orders awaiting delivery"},
        {"Card_ID": "CARD-14", "Card_Title": "In Transit", "Primary_Value": f"{len(in_transit_df)} ({len(in_transit_df)} orders on the way of {total_orders})", "Display_Value": f"{len(in_transit_df)} ({len(in_transit_df)} orders on the way of {total_orders})", "Subtext_Line_1": f"{len(in_transit_df)} orders on the way of {total_orders}", "Subtext_Line_2": f"Count {len(in_transit_df)} | Total Amount ₹{float(in_transit_df['Total Price'].sum()):,.2f} | Transit Rate {(len(in_transit_df)/total_orders)*100:.1f}%", "Full_Card_Text": f"In Transit: {len(in_transit_df)} | Amount: ₹{float(in_transit_df['Total Price'].sum()):,.2f} | Subtext: {len(in_transit_df)} orders on the way"},
        {"Card_ID": "CARD-15", "Card_Title": "Pickup Scheduled", "Primary_Value": f"{len(pickup_df)} ({len(pickup_df)} orders ready for pickup of {total_orders})", "Display_Value": f"{len(pickup_df)} ({len(pickup_df)} orders ready for pickup of {total_orders})", "Subtext_Line_1": f"{len(pickup_df)} orders ready for pickup of {total_orders}", "Subtext_Line_2": f"Count {len(pickup_df)} | Total Amount ₹{float(pickup_df['Total Price'].sum()):,.2f} | Pickup Rate {(len(pickup_df)/total_orders)*100:.1f}%", "Full_Card_Text": f"Pickup Scheduled: {len(pickup_df)} | Amount: ₹{float(pickup_df['Total Price'].sum()):,.2f} | Subtext: {len(pickup_df)} orders ready for pickup"},
        {"Card_ID": "CARD-16", "Card_Title": "Unfulfilled", "Primary_Value": f"{len(unfulfilled_df)} ({len(unfulfilled_df)} orders pending shipment of {total_orders})", "Display_Value": f"{len(unfulfilled_df)} ({len(unfulfilled_df)} orders pending shipment of {total_orders})", "Subtext_Line_1": f"{len(unfulfilled_df)} orders pending shipment of {total_orders}", "Subtext_Line_2": f"Count {len(unfulfilled_df)} | Total Amount ₹{float(unfulfilled_df['Total Price'].sum()):,.2f} | Unfulfilled Rate {(len(unfulfilled_df)/total_orders)*100:.1f}%", "Full_Card_Text": f"Unfulfilled: {len(unfulfilled_df)} | Amount: ₹{float(unfulfilled_df['Total Price'].sum()):,.2f} | Subtext: {len(unfulfilled_df)} orders pending shipment"},
        
        {"Card_ID": "CARD-17", "Card_Title": "Total Meta Ad Spend", "Primary_Value": "₹2,26,394.41 (Apr 01 - Aug 04)", "Display_Value": "₹2,26,394.41 (Apr 01 - Aug 04)", "Subtext_Line_1": "Total Meta Ads spend (Apr 01 - Aug 04)", "Subtext_Line_2": "Includes Advantage+, Reels, Insta & WA Ads", "Full_Card_Text": "Total Meta Ad Spend: ₹2,26,394.41 | Subtext: Total Meta Ads spend (Apr 01 - Aug 04)"},
        {"Card_ID": "CARD-18", "Card_Title": "Total Meta Impressions", "Primary_Value": "13.86M (13.86M ad impressions)", "Display_Value": "13.86M (13.86M ad impressions)", "Subtext_Line_1": "13.86M ad impressions served across Meta", "Subtext_Line_2": "13,862,586 total impressions", "Full_Card_Text": "Total Meta Impressions: 13.86M | Subtext: 13.86M ad impressions served"},
        {"Card_ID": "CARD-19", "Card_Title": "Total Meta Reach", "Primary_Value": "13.15M (13.15M unique reach)", "Display_Value": "13.15M (13.15M unique reach)", "Subtext_Line_1": "13.15M unique users reached across Meta", "Subtext_Line_2": "13,156,590 total unique reach", "Full_Card_Text": "Total Meta Reach: 13.15M | Subtext: 13.15M unique users reached"},
        {"Card_ID": "CARD-20", "Card_Title": "Cost Per Purchase (CPA)", "Primary_Value": "₹1,155.07 (Ad spend / 196 conversions)", "Display_Value": "₹1,155.07 (Ad spend / 196 conversions)", "Subtext_Line_1": "Ad spend / 196 pixel purchase conversions", "Subtext_Line_2": "Average cost to acquire 1 purchase", "Full_Card_Text": "Cost Per Purchase (CPA): ₹1,155.07 | Subtext: Ad spend / 196 pixel purchase conversions"},
        {"Card_ID": "CARD-21", "Card_Title": "Gross ROAS", "Primary_Value": "1.72x (Gross Sales ₹3,89,789 / Spend ₹2,26,394)", "Display_Value": "1.72x (Gross Sales ₹3,89,789 / Spend ₹2,26,394)", "Subtext_Line_1": "Gross Sales (₹3,89,789) / Ad Spend (₹2,26,394)", "Subtext_Line_2": "1.72x Gross Return on Ad Spend", "Full_Card_Text": "Gross ROAS: 1.72x | Subtext: Gross Sales (₹3,89,789) / Ad Spend (₹2,26,394)"},
        {"Card_ID": "CARD-22", "Card_Title": "Net ROAS", "Primary_Value": "1.48x (Net Sales ₹3,34,273 / Spend ₹2,26,394)", "Display_Value": "1.48x (Net Sales ₹3,34,273 / Spend ₹2,26,394)", "Subtext_Line_1": "Net Sales (₹3,34,273) / Ad Spend (₹2,26,394)", "Subtext_Line_2": "1.48x Net Return on Ad Spend", "Full_Card_Text": "Net ROAS: 1.48x | Subtext: Net Sales (₹3,34,273) / Ad Spend (₹2,26,394)"}
    ])
